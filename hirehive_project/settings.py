"""
Django settings for hirehive_project project.
...
SECRET_KEY = "django-insecure-ng4yhud_5n_@qkwk0hd1n@*21yr&ecj+&v15fu+#nk(m#t1(3o"
...
ROOT_URLCONF = "hirehive_project.urls"

TEMPLATES = [
    {
        "BACKEND": "django.template.backends.django.DjangoTemplates",
        "DIRS": [os.path.join(BASE_DIR, 'hirehive_project/templates')],
        "APP_DIRS": True,
        "OPTIONS": {
            "context_processors": [
...
WSGI_APPLICATION = "hirehive_project.wsgi.application"
...
STATICFILES_DIRS = [
    BASE_DIR / 'hirehive_project/static/',
]
